...
l1_feature_map = test.convolveInput(img, {"stride" : 1, "filters" : l1_filter})
print("\n**ReLU**")
l1_feature_map_relu = test.relu(l1_feature_map, None)
print("\n**Pooling**")
l1_feature_map_relu_pool = test.maxPooling(l1_feature_map_relu, {"partitionSize" : 2})
print("**End of conv layer 1**\n")

# Second conv layer
l2_filter = numpy.random.rand(l1_feature_map_relu_pool.shape[0], 3, 5, 5)
print("\n**Working with conv layer 2**")
l2_feature_map = test.convolveFeatures(l1_feature_map_relu_pool, {"stride" : 1, "filters" : l2_filter})
print("\n**ReLU**")
l2_feature_map_relu = test.relu(l2_feature_map, None)
print("\n**Pooling**")
l2_feature_map_relu_pool = test.maxPooling(l2_feature_map_relu, {"partitionSize" : 2})
print("**End of conv layer 2**\n")

# Third conv layer
l3_filter = numpy.random.rand(l2_feature_map_relu_pool.shape[0], 1, 7, 7)
print("\n**Working with conv layer 3**")
l3_feature_map = test.convolveFeatures(l2_feature_map_relu_pool, {"stride" : 1, "filters" : l3_filter})
print("\n**ReLU**")
l3_feature_map_relu = test.relu(l3_feature_map, None)
print("\n**Pooling**")
l3_feature_map_relu_pool = test.maxPooling(l3_feature_map_relu, {"partitionSize" : 2})
