...
l1_feature_map = test.conv(img, l1_filter)
print(l1_feature_map.shape)
print("\n**ReLU**")
l1_feature_map_relu = test.relu(l1_feature_map)
print(l1_feature_map_relu.shape)
print("\n**Pooling**")
l1_feature_map_relu_pool = test.pooling(l1_feature_map_relu, 2, 2)
...
l2_feature_map = test.conv(l1_feature_map_relu_pool, l2_filter)
print("\n**ReLU**")
l2_feature_map_relu = test.relu(l2_feature_map)
print("\n**Pooling**")
l2_feature_map_relu_pool = test.pooling(l2_feature_map_relu, 2, 2)
print("**End of conv layer 2**\n")

# Third conv layer
l3_filter = numpy.random.rand(1, 7, 7, l2_feature_map_relu_pool.shape[-1])
print("\n**Working with conv layer 3**")
l3_feature_map = test.conv(l2_feature_map_relu_pool, l3_filter)
print("\n**ReLU**")
l3_feature_map_relu = test.relu(l3_feature_map)
print("\n**Pooling**")
l3_feature_map_relu_pool = test.pooling(l3_feature_map_relu, 2, 2)
